...
namespace NETCleanArchApi.Controllers
{
    ...
    public class ServiceRegistryController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllServiceRegistry([FromQuery] PaginationRequest paginationRequest)
        {
            try
            {
                var response = await _serviceRegistryService.GetAllServiceRegistry(paginationRequest);
        ...
        public async Task<IActionResult> AddServiceRegistry([FromBody] ServiceRegistryDto serviceRegistryDto)
        {
            try
            {
                var response = await _serviceRegistryService.AddServiceRegistry(serviceRegistryDto);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
        ...
        public async Task<IActionResult> GetServiceRegistryById(long serviceRegistryId)
        {
            try
            {
                var response = await _serviceRegistryService.GetServiceRegistryById(serviceRegistryId);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
        ...
        public async Task<IActionResult> UpdateServiceRegistry([FromBody] ServiceRegistryDto serviceRegistryDto)
        {
            try
            {
                var response = await _serviceRegistryService.UpdateServiceRegistry(serviceRegistryDto);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
        ...
        public async Task<IActionResult> DeleteServiceRegistry(long serviceRegistryId)
        {
            try
            {
                var response = await _serviceRegistryService.DeleteServiceRegistry(serviceRegistryId);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
        ...
        public async Task<IActionResult> GetAllServiceSchemas([FromQuery] PaginationRequest paginationRequest)
        {
            try
            {
                var response = await _serviceRegistryService.GetAllServiceSchemas(paginationRequest);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
        ...
        public async Task<IActionResult> GetSchemasByApplicationId(long applicationId, [FromQuery] PaginationRequest paginationRequest)
        {
            try
            {
                var response = await _serviceRegistryService.GetSchemasByApplicationId(applicationId, paginationRequest);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
        ...
        public async Task<IActionResult> GetSchemasByServiceId(long serviceId, [FromQuery] PaginationRequest paginationRequest)
        {
            try
            {
                var response = await _serviceRegistryService.GetSchemasByServiceId(serviceId, paginationRequest);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
        ...
        public async Task<IActionResult> AddServiceSchema([FromBody] ServiceSchemaDto serviceSchemaDto)
        {
            try
            {
                var response = await _serviceRegistryService.AddServiceSchema(serviceSchemaDto);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
        ...
        public async Task<IActionResult> GetServiceSchemaById(long schemaId)
        {
            try
            {
                var response = await _serviceRegistryService.GetServiceSchemaById(schemaId);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
        ...
        public async Task<IActionResult> UpdateServiceSchema([FromBody] ServiceSchemaDto serviceSchemaDto)
        {
            try
            {
                var response = await _serviceRegistryService.UpdateServiceSchema(serviceSchemaDto);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
        ...
        public async Task<IActionResult> DeleteServiceSchema(long schemaId)
        {
            try
            {
                var response = await _serviceRegistryService.DeleteServiceSchema(schemaId);
                if (response.IsSuccess)
                    return Ok(response);
                else
                    return StatusCode(500, response);
